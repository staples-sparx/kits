...
(deftest test-info-log-level
  (stubbing [syslog/log nil
           ...
           (verify-first-call-args-for-indices
            ...
            syslog-local-name
            6
            "{\"tags\":[\"my-special-error\"],\"level\":\"INFO\",\"timestamp\":123456789,\"data\":{\"a\":1,\"b\":2,\"c\":\"<HasNoDefaultSerializer>\"}}")))
...
(deftest test-warn-log-level
  (stubbing [syslog/log nil
           ...
           (verify-first-call-args-for-indices
            ...
            syslog-local-name
            4
            "{\"level\":\"WARN\",\"timestamp\":123456789,\"data\":{\"c\":3,\"d\":4}}")))
  ...
  (let [state-checker (fn [] @state)]
    (stubbing [syslog/log nil
             ...
             (verify-first-call-args-for-indices
              ...
              syslog-local-name
              3
              "{\"context\":{\"state\":88,\"request/id\":\"req123\",\"transaction/id\":\"txn123\"},\"tags\":[\"import\",\"bad-csv-row\"],\"level\":\"ERROR\",\"timestamp\":123456789,\"data\":{\"c\":3,\"d\":4}}"))))
...
(deftest test-log-time
  (stubbing [syslog/log nil] ;; this is here to suppress console output
